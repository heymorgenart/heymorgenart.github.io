...
const baseURL: string = "https://heymorgenart.github.io";
...
// Password protection requires a server and cannot work on static hosting
// (GitHub Pages). Left empty so all routes are public.
