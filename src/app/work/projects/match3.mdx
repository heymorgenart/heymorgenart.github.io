...
<div style={{ width: '100%', maxWidth: '360px', margin: '16px auto 24px' }}>
  <div style={{ position: 'relative', width: '100%', paddingBottom: '177.5%', borderRadius: '12px', overflow: 'hidden' }}>
    <iframe
      title="vimeo-player"
      src="https://player.vimeo.com/video/1205935418?h=145b131e63"
      width="640"
      height="360"
